...
```{r, echo=FALSE, fig.cap="Figure 4.Scoring on different models.", out.width = '50%'}
htmltools::includeHTML("file:///Users/junting/DSCI_522_Group_10/results/model_selection.html")
```
...
```{r, echo=FALSE, fig.cap="Figure 5. Results of hyperparameter optimization.", out.width = '50%'}
htmltools::includeHTML("file:///Users/junting/DSCI_522_Group_10/results/hyperparameter_optimization_result.html")
```
